...
export default (apiUrl:string, httpClient = fetchUtils.fetchJson): DataProvider => ({
    getList: (resource, params) => {
        ...
        const UrlObject  = JSON.parse(JSON.stringify(params));
        ...
        if (UrlObject.hasOwnProperty('iec')) 
            Object.assign(query, {iec: JSON.stringify(UrlObject.iec)});

        /// Temporary to work around Customers - Resource Names to give dashboardmainpage results for everything
        if (resource === 'customers') {
            resource = 'dashboardmainpage';
            Object.assign(query, {iec: 7095639485});
        }
